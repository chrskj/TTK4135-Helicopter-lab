 ...
 */
#ifndef RTW_HEADER_part4_heli_h_
#define RTW_HEADER_part4_heli_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef part4_heli_COMMON_INCLUDES_
# define part4_heli_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* part4_heli_COMMON_INCLUDES_ */

#include "part4_heli_types.h"
...
#define part4_heli_rtModel             RT_MODEL_part4_heli_T
...
#define rtB                            part4_heli_B
#define BlockIO                        B_part4_heli_T
#define rtX                            part4_heli_X
#define ContinuousStates               X_part4_heli_T
#define rtXdot                         part4_heli_XDot
#define StateDerivatives               XDot_part4_heli_T
#define tXdis                          part4_heli_XDis
#define StateDisabled                  XDis_part4_heli_T
#define rtP                            part4_heli_P
#define Parameters                     P_part4_heli_T
#define rtDWork                        part4_heli_DW
#define D_Work                         DW_part4_heli_T

/* Parameters (auto storage) */
struct P_part4_heli_T_ {
...
extern P_part4_heli_T part4_heli_P;

/* Block signals (auto storage) */
extern B_part4_heli_T part4_heli_B;

/* Continuous states (auto storage) */
extern X_part4_heli_T part4_heli_X;

/* Block states (auto storage) */
extern DW_part4_heli_T part4_heli_DW;

/* Model entry point functions */
extern void part4_heli_initialize(void);
extern void part4_heli_output(void);
extern void part4_heli_update(void);
extern void part4_heli_terminate(void);

/* Real-time Model object */
extern RT_MODEL_part4_heli_T *const part4_heli_M;
 ...
 *
 * '<Root>' : 'part4_heli'
 * '<S1>'   : 'part4_heli/Conversion'
 * '<S2>'   : 'part4_heli/Degrees to Radians'
 * '<S3>'   : 'part4_heli/Elevation controller'
 * '<S4>'   : 'part4_heli/Helicopter_interface'
 * '<S5>'   : 'part4_heli/LQR'
 * '<S6>'   : 'part4_heli/Pitch controller'
 * '<S7>'   : 'part4_heli/Helicopter_interface/Elevation rad to deg'
 * '<S8>'   : 'part4_heli/Helicopter_interface/Elevation rate rad to deg'
 * '<S9>'   : 'part4_heli/Helicopter_interface/Pitch rad to deg'
 * '<S10>'  : 'part4_heli/Helicopter_interface/Pitch rate rad to deg'
 * '<S11>'  : 'part4_heli/Helicopter_interface/Pitch rate rad to deg1'
 * '<S12>'  : 'part4_heli/Helicopter_interface/Travel rad to deg'
 * '<S13>'  : 'part4_heli/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_part4_heli_h_ */
