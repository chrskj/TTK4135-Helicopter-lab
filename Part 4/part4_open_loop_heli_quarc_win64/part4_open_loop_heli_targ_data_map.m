  ...
  ;%***********************
    ...
    ;%
    ;% Auto data (part4_open_loop_heli_P)
    ;%
      section.nData     = 25;
      section.data(25)  = dumData; %prealloc
      
	  ;% part4_open_loop_heli_P.K_ed
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% part4_open_loop_heli_P.K_ei
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 1;
	
	  ;% part4_open_loop_heli_P.K_ep
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 2;
	
	  ;% part4_open_loop_heli_P.K_pd
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 3;
	
	  ;% part4_open_loop_heli_P.K_pp
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 4;
	
	  ;% part4_open_loop_heli_P.Vd_ff
	  section.data(6).logicalSrcIdx = 5;
	  section.data(6).dtTransOffset = 5;
	
	  ;% part4_open_loop_heli_P.Vs_ff
	  section.data(7).logicalSrcIdx = 6;
	  section.data(7).dtTransOffset = 6;
	
	  ;% part4_open_loop_heli_P.x1_0
	  ...
	  ;% part4_open_loop_heli_P.HILInitialize_set_other_outputs
	  section.data(20).logicalSrcIdx = 19;
	  section.data(20).dtTransOffset = 19;
	
	  ;% part4_open_loop_heli_P.HILInitialize_set_other_outpu_m
	  section.data(21).logicalSrcIdx = 20;
	  section.data(21).dtTransOffset = 20;
	
	  ;% part4_open_loop_heli_P.HILInitialize_set_other_outpu_k
	  section.data(22).logicalSrcIdx = 21;
	  section.data(22).dtTransOffset = 21;
	
	  ;% part4_open_loop_heli_P.HILInitialize_set_other_outpu_j
	  ...
	  ;% part4_open_loop_heli_P.HILReadEncoderTimebase_clock
	  section.data(1).logicalSrcIdx = 25;
	  section.data(1).dtTransOffset = 0;
	
	  ;% part4_open_loop_heli_P.HILInitialize_hardware_clocks
	  ...
	  ;% part4_open_loop_heli_P.HILInitialize_pwm_modes
	  ...
	  ;% part4_open_loop_heli_P.HILInitialize_watchdog_digital_
	  ...
	  ;% part4_open_loop_heli_P.HILInitialize_analog_input_chan
	  ...
	  ;% part4_open_loop_heli_P.HILReadEncoderTimebase_channels
	  section.data(3).logicalSrcIdx = 35;
	  section.data(3).dtTransOffset = 16;
	
	  ;% part4_open_loop_heli_P.HILWriteAnalog_channels
	  section.data(4).logicalSrcIdx = 36;
	  section.data(4).dtTransOffset = 19;
	
	  ;% part4_open_loop_heli_P.HILInitialize_encoder_channels
	  ...
	  ;% part4_open_loop_heli_P.HILInitialize_active
	  section.data(1).logicalSrcIdx = 41;
	  section.data(1).dtTransOffset = 0;
	
	  ;% part4_open_loop_heli_P.HILInitialize_final_digital_out
	  section.data(2).logicalSrcIdx = 42;
	  section.data(2).dtTransOffset = 1;
	
	  ;% part4_open_loop_heli_P.HILInitialize_initial_digital_o
	  section.data(3).logicalSrcIdx = 43;
	  section.data(3).dtTransOffset = 2;
	
	  ;% part4_open_loop_heli_P.HILInitialize_set_analog_input_
	  ...
	  ;% part4_open_loop_heli_P.HILInitialize_set_analog_output
	  ...
	  ;% part4_open_loop_heli_P.HILInitialize_set_analog_outp_e
	  ...
	  ;% part4_open_loop_heli_P.HILInitialize_set_analog_out_ex
	  section.data(11).logicalSrcIdx = 51;
	  section.data(11).dtTransOffset = 10;
	
	  ;% part4_open_loop_heli_P.HILInitialize_set_analog_outp_p
	  section.data(12).logicalSrcIdx = 52;
	  section.data(12).dtTransOffset = 11;
	
	  ;% part4_open_loop_heli_P.HILInitialize_set_clock_frequen
	  section.data(13).logicalSrcIdx = 53;
	  section.data(13).dtTransOffset = 12;
	
	  ;% part4_open_loop_heli_P.HILInitialize_set_clock_frequ_e
	  section.data(14).logicalSrcIdx = 54;
	  section.data(14).dtTransOffset = 13;
	
	  ;% part4_open_loop_heli_P.HILInitialize_set_clock_params_
	  section.data(15).logicalSrcIdx = 55;
	  section.data(15).dtTransOffset = 14;
	
	  ;% part4_open_loop_heli_P.HILInitialize_set_clock_param_c
	  section.data(16).logicalSrcIdx = 56;
	  section.data(16).dtTransOffset = 15;
	
	  ;% part4_open_loop_heli_P.HILInitialize_set_digital_outpu
	  section.data(17).logicalSrcIdx = 57;
	  section.data(17).dtTransOffset = 16;
	
	  ;% part4_open_loop_heli_P.HILInitialize_set_digital_out_b
	  section.data(18).logicalSrcIdx = 58;
	  section.data(18).dtTransOffset = 17;
	
	  ;% part4_open_loop_heli_P.HILInitialize_set_digital_out_c
	  section.data(19).logicalSrcIdx = 59;
	  section.data(19).dtTransOffset = 18;
	
	  ;% part4_open_loop_heli_P.HILInitialize_set_digital_ou_c1
	  section.data(20).logicalSrcIdx = 60;
	  section.data(20).dtTransOffset = 19;
	
	  ;% part4_open_loop_heli_P.HILInitialize_set_digital_out_a
	  section.data(21).logicalSrcIdx = 61;
	  section.data(21).dtTransOffset = 20;
	
	  ;% part4_open_loop_heli_P.HILInitialize_set_digital_out_j
	  section.data(22).logicalSrcIdx = 62;
	  section.data(22).dtTransOffset = 21;
	
	  ;% part4_open_loop_heli_P.HILInitialize_set_digital_out_m
	  section.data(23).logicalSrcIdx = 63;
	  section.data(23).dtTransOffset = 22;
	
	  ;% part4_open_loop_heli_P.HILInitialize_set_encoder_count
	  ...
	  ;% part4_open_loop_heli_P.HILInitialize_set_encoder_param
	  ...
	  ;% part4_open_loop_heli_P.HILInitialize_set_other_outpu_l
	  section.data(28).logicalSrcIdx = 68;
	  section.data(28).dtTransOffset = 27;
	
	  ;% part4_open_loop_heli_P.HILInitialize_set_pwm_outputs_a
	  ...
	  ;% part4_open_loop_heli_P.HILInitialize_set_pwm_output_ap
	  section.data(32).logicalSrcIdx = 72;
	  section.data(32).dtTransOffset = 31;
	
	  ;% part4_open_loop_heli_P.HILInitialize_set_pwm_outputs_o
	  section.data(33).logicalSrcIdx = 73;
	  section.data(33).dtTransOffset = 32;
	
	  ;% part4_open_loop_heli_P.HILInitialize_set_pwm_params_at
	  ...
	  ;% part4_open_loop_heli_P.Gain_Gain
	  ...
	  ;% part4_open_loop_heli_P.TravelTransferFcn_C
	  section.data(4).logicalSrcIdx = 79;
	  section.data(4).dtTransOffset = 3;
	
	  ;% part4_open_loop_heli_P.TravelTransferFcn_D
	  section.data(5).logicalSrcIdx = 80;
	  section.data(5).dtTransOffset = 4;
	
	  ;% part4_open_loop_heli_P.Gain_Gain_l
	  ...
	  ;% part4_open_loop_heli_P.Gain_Gain_a
	  section.data(8).logicalSrcIdx = 83;
	  section.data(8).dtTransOffset = 7;
	
	  ;% part4_open_loop_heli_P.PitchTransferFcn_A
	  section.data(9).logicalSrcIdx = 84;
	  section.data(9).dtTransOffset = 8;
	
	  ;% part4_open_loop_heli_P.PitchTransferFcn_C
	  section.data(10).logicalSrcIdx = 85;
	  section.data(10).dtTransOffset = 9;
	
	  ;% part4_open_loop_heli_P.PitchTransferFcn_D
	  section.data(11).logicalSrcIdx = 86;
	  section.data(11).dtTransOffset = 10;
	
	  ;% part4_open_loop_heli_P.Gain_Gain_ae
	  ...
	  ;% part4_open_loop_heli_P.Gain_Gain_lv
	  ...
	  ;% part4_open_loop_heli_P.ElevationTransferFcn_C
	  section.data(17).logicalSrcIdx = 92;
	  section.data(17).dtTransOffset = 16;
	
	  ;% part4_open_loop_heli_P.ElevationTransferFcn_D
	  section.data(18).logicalSrcIdx = 93;
	  section.data(18).dtTransOffset = 17;
	
	  ;% part4_open_loop_heli_P.Gain_Gain_n
	  section.data(19).logicalSrcIdx = 94;
	  section.data(19).dtTransOffset = 18;
	
	  ;% part4_open_loop_heli_P.Gain1_Gain
	  ...
	  ;% part4_open_loop_heli_P.Gain_Gain_a1
	  ...
	  ;% part4_open_loop_heli_P.HILReadEncoderTimebase_Active
	  section.data(1).logicalSrcIdx = 106;
	  section.data(1).dtTransOffset = 0;
	
	  ;% part4_open_loop_heli_P.HILWriteAnalog_Active
  ...
  ;%**************************
    ...
    ;%
    ;% Auto data (part4_open_loop_heli_B)
    ;%
      section.nData     = 20;
	  ...
	  ;% part4_open_loop_heli_B.Sum2
	  section.data(16).logicalSrcIdx = 15;
	  section.data(16).dtTransOffset = 20;
	
	  ;% part4_open_loop_heli_B.K_ei
	  section.data(17).logicalSrcIdx = 16;
	  section.data(17).dtTransOffset = 21;
	
	  ;% part4_open_loop_heli_B.Gain_l
	  section.data(18).logicalSrcIdx = 17;
  ...
  ;%*******************
    ...
    ;%
    ;% Auto data (part4_open_loop_heli_DW)
    ;%
      section.nData     = 13;
      section.data(13)  = dumData; %prealloc
      
	  ;% part4_open_loop_heli_DW.HILInitialize_AIMinimums
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% part4_open_loop_heli_DW.HILInitialize_AIMaximums
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 8;
	
	  ;% part4_open_loop_heli_DW.HILInitialize_AOMinimums
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 16;
	
	  ;% part4_open_loop_heli_DW.HILInitialize_AOMaximums
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 24;
	
	  ;% part4_open_loop_heli_DW.HILInitialize_AOVoltages
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 32;
	
	  ;% part4_open_loop_heli_DW.HILInitialize_FilterFrequency
	  section.data(6).logicalSrcIdx = 5;
	  section.data(6).dtTransOffset = 40;
	
	  ;% part4_open_loop_heli_DW.HILInitialize_POSortedFreqs
	  section.data(7).logicalSrcIdx = 6;
	  section.data(7).dtTransOffset = 48;
	
	  ;% part4_open_loop_heli_DW.HILInitialize_POValues
	  section.data(8).logicalSrcIdx = 7;
	  section.data(8).dtTransOffset = 56;
	
	  ;% part4_open_loop_heli_DW.TimeStampA
	  section.data(9).logicalSrcIdx = 8;
	  section.data(9).dtTransOffset = 64;
	
	  ;% part4_open_loop_heli_DW.LastUAtTimeA
	  section.data(10).logicalSrcIdx = 9;
	  ...
	  ;% part4_open_loop_heli_DW.LastUAtTimeB
	  section.data(12).logicalSrcIdx = 11;
	  section.data(12).dtTransOffset = 67;
	
	  ;% part4_open_loop_heli_DW.HILWriteAnalog_Buffer
	  section.data(13).logicalSrcIdx = 12;
	  ...
	  ;% part4_open_loop_heli_DW.ToFile1_PWORK.FilePtr
	  ...
	  ;% part4_open_loop_heli_DW.Vd_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 17;
	  section.data(3).dtTransOffset = 2;
	
	  ;% part4_open_loop_heli_DW.Vd_bias_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 18;
	  section.data(4).dtTransOffset = 3;
	
	  ;% part4_open_loop_heli_DW.Vs_PWORK.LoggedData
	  section.data(5).logicalSrcIdx = 19;
	  section.data(5).dtTransOffset = 4;
	
	  ;% part4_open_loop_heli_DW.Vs_bias_PWORK.LoggedData
	  section.data(6).logicalSrcIdx = 20;
	  section.data(6).dtTransOffset = 5;
	
	  ;% part4_open_loop_heli_DW.elevation_PWORK.LoggedData
	  section.data(7).logicalSrcIdx = 21;
	  section.data(7).dtTransOffset = 6;
	
	  ;% part4_open_loop_heli_DW.elevation_r_PWORK.LoggedData
	  section.data(8).logicalSrcIdx = 22;
	  section.data(8).dtTransOffset = 7;
	
	  ;% part4_open_loop_heli_DW.pitch_PWORK.LoggedData
	  section.data(9).logicalSrcIdx = 23;
	  section.data(9).dtTransOffset = 8;
	
	  ;% part4_open_loop_heli_DW.pitch_r_PWORK.LoggedData
	  section.data(10).logicalSrcIdx = 24;
	  section.data(10).dtTransOffset = 9;
	
	  ;% part4_open_loop_heli_DW.travel_PWORK.LoggedData
	  section.data(11).logicalSrcIdx = 25;
	  section.data(11).dtTransOffset = 10;
	
	  ;% part4_open_loop_heli_DW.travel_r_PWORK.LoggedData
	  section.data(12).logicalSrcIdx = 26;
	  section.data(12).dtTransOffset = 11;
	
	  ;% part4_open_loop_heli_DW.ElevationScopedegs_PWORK.LoggedData
	  section.data(13).logicalSrcIdx = 27;
	  section.data(13).dtTransOffset = 12;
	
	  ;% part4_open_loop_heli_DW.ElevationScopedeg_PWORK.LoggedData
	  section.data(14).logicalSrcIdx = 28;
	  section.data(14).dtTransOffset = 13;
	
	  ;% part4_open_loop_heli_DW.PitchScopedeg_PWORK.LoggedData
	  section.data(15).logicalSrcIdx = 29;
	  section.data(15).dtTransOffset = 14;
	
	  ;% part4_open_loop_heli_DW.PtichrateScopedegs_PWORK.LoggedData
	  section.data(16).logicalSrcIdx = 30;
	  section.data(16).dtTransOffset = 15;
	
	  ;% part4_open_loop_heli_DW.PtichrateScopedegs1_PWORK.LoggedData
	  section.data(17).logicalSrcIdx = 31;
	  section.data(17).dtTransOffset = 16;
	
	  ;% part4_open_loop_heli_DW.TravelrateScopedegs_PWORK.LoggedData
	  section.data(18).logicalSrcIdx = 32;
	  section.data(18).dtTransOffset = 17;
	
	  ;% part4_open_loop_heli_DW.TravelScopedeg_PWORK.LoggedData
	  section.data(19).logicalSrcIdx = 33;
	  section.data(19).dtTransOffset = 18;
	
	  ;% part4_open_loop_heli_DW.Backmotor_PWORK.LoggedData
	  section.data(20).logicalSrcIdx = 34;
	  section.data(20).dtTransOffset = 19;
	
	  ;% part4_open_loop_heli_DW.Frontmotor_PWORK.LoggedData
	  section.data(21).logicalSrcIdx = 35;
	  section.data(21).dtTransOffset = 20;
	
	  ;% part4_open_loop_heli_DW.HILWriteAnalog_PWORK
	  ...
	  ;% part4_open_loop_heli_DW.HILInitialize_ClockModes
	  section.data(1).logicalSrcIdx = 37;
	  section.data(1).dtTransOffset = 0;
	
	  ;% part4_open_loop_heli_DW.HILInitialize_QuadratureModes
	  section.data(2).logicalSrcIdx = 38;
	  section.data(2).dtTransOffset = 3;
	
	  ;% part4_open_loop_heli_DW.HILInitialize_InitialEICounts
	  section.data(3).logicalSrcIdx = 39;
	  section.data(3).dtTransOffset = 11;
	
	  ;% part4_open_loop_heli_DW.HILInitialize_POModeValues
	  section.data(4).logicalSrcIdx = 40;
	  section.data(4).dtTransOffset = 19;
	
	  ;% part4_open_loop_heli_DW.HILInitialize_POAlignValues
	  section.data(5).logicalSrcIdx = 41;
	  section.data(5).dtTransOffset = 27;
	
	  ;% part4_open_loop_heli_DW.HILInitialize_POPolarityVals
	  section.data(6).logicalSrcIdx = 42;
	  section.data(6).dtTransOffset = 35;
	
	  ;% part4_open_loop_heli_DW.HILReadEncoderTimebase_Buffer
	  ...
	  ;% part4_open_loop_heli_DW.HILInitialize_POSortedChans
	  ...
	  ;% part4_open_loop_heli_DW.ToFile1_IWORK.Count
	  section.data(1).logicalSrcIdx = 45;
	  section.data(1).dtTransOffset = 0;
	
	  ;% part4_open_loop_heli_DW.FromWorkspace2_IWORK.PrevIndex
  ...
  targMap.checksum0 = 3048316392;
  targMap.checksum1 = 356815293;
  targMap.checksum2 = 2905853496;
  targMap.checksum3 = 1652764699;
